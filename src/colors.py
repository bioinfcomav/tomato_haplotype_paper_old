...
'sp_ec_n_wet_forest': '#ffc087',

'sp_pe_desert_x_sp_pe_n_inter_andean': '#D8D8D8',
'sp_pe_x_sp_ec': '#D8D8D8',

'slc_ec_n_600m': '#ffc087',
'slc_ec_c_800m': '#8d6e63',
'slc_ec_s_1000m': '#D2B48C',
'slc_ec_guayaquil': '#DAA520',

'slc_co': '#f5ea6f',
'slc_mx_sinaloa': '#b9936c',
'slc_ca': '#ffee58',
'slc_mx': '#b3b300',

'sp_x_sl': '#808000',
'sp_x_sl_cherry_cultivars': '#808000',
...
"""
TRADITOM_COLOR_MAPPINGS = {'': '#D8D8D8',
                  'SP': '#808000',
                  'SP_NEcu': '#2E8B57',
                  'Galapagos': '#556B2F',
                  'green': '#3CB371',
                  'modern_lsl_and_processing': '#57acff',
                  'modern_processing': '#80ced6',
                  'modern_fresh_1': '#92a8d1',
                  'modern_fresh_2': '#667292',
                  'heinz1706': '#EE82EE',
                  'vintage': '#ff6347',
                  'SPxSL': '#cab577',
                  'SLC_Ecu': '#F4A460',
                  ...
                  'valenciano': '#ff6347',
                  'bell_pepper': '#1E90FF',
                  'scatolone_di_bolsena': '#DAA520',
                  'spagnoletta': '#6495ED',
                  'palosanto_pometa_2': '#FFA500',
                  'muchamiel': '#B22222',
                  'marmande': '#DC143C',
                  'lemonia': '#667292',
                  'lsl_penjar_vlc': '#808000',
                  'lsl_penjar_cat': '#40E0D0',
                  'montserrat': '#eca1a6',
                  'palosanto_pometa_1': '#FFA07A',
                  'cor_de_bou': '#FA8072',
                  'pimiento': '#CD5C5C',
                  'lsl_da_serbo': '#9ACD32',
                  'lsl_heart': '#3CB371',
                  'lsl_piennolo': '#556B2F',
                  'lsl_ramellet': '#8FBC8F',
                  'balearic_cherry': '#8d6e63',
                  'tondo_piccolo': '#6b5b95',
                  'grc': '#b9936c',
                  'ita_ellipsoid': '#ba68c8',
                  'ita_grc': '#DDA0DD',
                  'ita_small': '#ffee58',
                  'liguria': '#D2B48C',
                  'pera_girona': '#FF69B4',
