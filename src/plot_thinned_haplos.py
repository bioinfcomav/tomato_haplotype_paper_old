...
def _classify_haplo_pcoas(aligned_pcoas_df, classification_config, only_thinned=False):
    ...
    if thinning_dist_threshold is not None and not only_thinned:
...
def remove_outliers_from_classified_clusters(classification, aligned_pcoas_df,
    ...
    for klass, haplo_ids in haplo_ids_by_class.items():
        ...
        res = _detect_outliers(aligned_pcoas_df_for_this_class,
                               outlier_config)
