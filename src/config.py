...
FIG_ACC_PCA_HIERALCHICAL = FIGURES_DIR / 'suppl_fig_3_hieralchical_acc_pcas.svg'
FIG_ACC_HAPLO_FREQS_AND_STRUCTURE = FIGURES_DIR / 'suppl_fig_4_acc_haplo_freqs_and_structure.svg'
...
FIG_MORPHOLOGICAL_VS_MOLECULAR_CLASSIFICATION = FIGURES_DIR / 'suppl_fig_10_morphological_vs_molecular_classification.svg'
