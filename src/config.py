...
FIG_DIVERSITIES_AND_LD = FIGURES_DIR / 'fig_4_diversities_and_ld.svg'
FIG_DIVERSITIES_BY_HAPLO_TYPE = FIGURES_DIR / 'fig_5_diversities_by_haplo_kind.svg'
FIG_THERE_AND_BACK = FIGURES_DIR / 'fig_6_slc_ma_genomic_diversity_vs_andean_slc_introgressions.svg'
FIG_HSL_SHARED_HAPLOS = FIGURES_DIR / 'fig_7_shared_shl_haplos.svg'
FIG_MORPHOLOGICAL_ANALYSIS = FIGURES_DIR / 'fig_8_morphological_analsysis.svg'
...
FIG_PI_DISTRIBUTIONS = FIGURES_DIR / 'suppl_fig_7_pi_distributions.svg'
FIG_HAPLO_FREQS = FIGURES_DIR / 'suppl_fig_8_haplo_freqs.svg'
FIG_MORPHOLOGICAL_VS_MOLECULAR_CLASSIFICATION = FIGURES_DIR / 'suppl_fig_9_morphological_vs_molecular_classification.svg'
FIG_COLLECTING_SOURCES = FIGURES_DIR / 'suppl_fig_10_collecting_sources.svg'
